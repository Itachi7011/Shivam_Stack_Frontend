...
import img2 from "../../../images/41441.jpg";
import img3 from "../../../images/62671.jpg";
import img4 from "../../../images/2f2.jpg";
import img5 from "../../../images/549.jpg";
import img6 from "../../../images/4741.jpg";
import img7 from "../../../images/d74.jpg";
...
const FullStackDevelopment = () => {
      ...
      items: [
        {
          icon: "⚛️",
          name: "React.js",
          desc: "Component-based UI with hooks, context, and modern patterns",
        },
        {
          icon: "▲",
          name: "Next.js",
          desc: "SSR, SSG, ISR — full SEO + performance powerhouse",
        },
        {
          icon: "🌀",
          name: "Redux Toolkit",
          desc: "Predictable state management at scale",
        },
        {
          icon: "🎨",
          name: "Tailwind CSS",
          desc: "Utility-first styling, pixel-perfect in no time",
        },
        {
          icon: "📘",
          name: "TypeScript",
          desc: "Type-safe code that scales without breaking",
        },
        {
          icon: "⚡",
          name: "Vite",
          desc: "Lightning-fast dev server and optimized builds",
        },
      ],
    },
    backend: {
      ...
      items: [
        {
          icon: "🟩",
          name: "Node.js",
          desc: "Non-blocking, event-driven server runtime",
        },
        {
          icon: "🚂",
          name: "Express.js",
          desc: "Minimal, flexible, production-proven framework",
        },
        {
          icon: "🔷",
          name: "GraphQL",
          desc: "Efficient data fetching with precise queries",
        },
        {
          icon: "🔌",
          name: "Socket.io",
        ...
        },
        {
          icon: "🛂",
          name: "Passport.js",
          desc: "Flexible authentication middleware",
        },
        {
          icon: "✔️",
          name: "Zod / Joi",
          desc: "Schema validation — bulletproof input handling",
        },
      ],
    },
    database: {
      ...
      items: [
        {
          icon: "🍃",
          name: "MongoDB",
          desc: "Flexible document storage for modern apps",
        },
        {
          icon: "🐘",
          name: "PostgreSQL",
          desc: "Rock-solid relational DB for complex data",
        },
        {
          icon: "🔥",
          name: "Redis",
        ...
        },
        {
          icon: "🔷",
          name: "Prisma",
          desc: "Next-gen ORM with type safety built-in",
        },
        {
          icon: "🟢",
          name: "Supabase",
          desc: "Open-source Firebase alternative with PostgreSQL",
        },
      ],
    },
  };
  ...
  const faqs = [
    {
      q: 'What does "full stack" mean for my project?',
      a: "It means I handle everything — frontend UI, backend API, database, authentication, file storage, email services, and deployment. You get a single developer accountable for the entire product, with no gaps between teams.",
    },
    {
      q: "Can you work with my existing tech stack?",
      a: "Yes. If you already have a React frontend or a Node backend, I can work with it. I'll audit the existing code, document the architecture, and build new features that fit naturally.",
    },
    {
      q: "How do you handle database migrations?",
      a: "For MongoDB I use migration scripts tracked in Git. For PostgreSQL/relational databases I use Prisma Migrate or Flyway with versioned migration files. All migrations are tested in staging before production.",
    },
    {
      q: "Do you write tests?",
      a: "Yes — unit tests with Jest, integration tests for APIs with Supertest, and end-to-end tests with Playwright for critical user flows. Coverage reports are included in every delivery.",
    },
    {
      q: "What happens if something breaks after launch?",
      a: "All projects include 30 days of free bug-fix support after launch. For ongoing needs, I offer monthly maintenance retainers. I also monitor error logs and will proactively alert you to issues.",
    },
    {
      q: "Can you build a mobile app too?",
      a: "I specialize in web applications (React, Next.js, PWAs). For native mobile, I can build React Native apps that share code with the web frontend, giving you iOS + Android + Web from one codebase.",
    },
  ];
  ...
  const processSteps = [
    {
      ...
      desc: "Deep dive into your business goals, user flows, and technical requirements. I create detailed wireframes and a feature specification document.",
    },
    {
      num: "02",
      icon: "🏗️",
      title: "System Architecture",
      desc: "Database schema design, API contract definition, component architecture, state management strategy, and infrastructure planning.",
    },
    {
      num: "03",
      icon: "🎨",
      title: "UI/UX Design",
      desc: "High-fidelity designs in Figma. Every screen, every interaction, every edge case — designed before a single line of code.",
    },
    {
      num: "04",
      icon: "⚙️",
      title: "Parallel Development",
      desc: "Frontend and backend developed simultaneously in weekly sprints. You get working demos every Friday.",
    },
    {
      num: "05",
      icon: "🧪",
      title: "Testing & QA",
      desc: "Unit tests, integration tests, E2E tests, performance audits, security scans, and cross-browser/device testing.",
    },
    {
      num: "06",
      icon: "🚀",
      title: "Deployment & Launch",
      desc: "Production deployment with CI/CD, monitoring setup, SSL configuration, domain pointing, and final handoff with full documentation.",
    },
  ];
  ...
  return (
    <div className={`shivam-stack-page ${isDarkMode ? "dark" : "light"}`}>
        ...
        <div className="shivam-stack-container">
          <div className="shivam-stack-hero-content">
            ...
            <div className="shivam-stack-hero-left">
              <a href="/services" className="shivam-stack-fsd-breadcrumb">
                ← All Services
              </a>
              ...
              <h1 className="shivam-stack-hero-title">
                Complete Web Apps{" "}
                <span className="shivam-stack-hero-title-gradient">
                  Built End-to-End
                </span>
              </h1>
              <p className="shivam-stack-hero-subtitle">
                From database architecture to pixel-perfect UI — I build
                complete, production-ready MERN stack applications that scale.
                One developer. Zero gaps. Full accountability.
              </p>
              <div className="shivam-stack-hero-cta-group">
                ...
                <a
                  href="#fsd-process"
                  className="shivam-stack-btn shivam-stack-btn--secondary"
                >
                  See My Process →
                </a>
              </div>
              <div className="shivam-stack-fsd-hero-stats">
                {[
                  ...
                  <div key={i} className="shivam-stack-fsd-hero-stat">
                    <div className="shivam-stack-fsd-hero-stat-num">
                      {s.num}
                    </div>
                    <div className="shivam-stack-fsd-hero-stat-label">
                      {s.label}
                    </div>
                  </div>
                ))}
            ...
            <div className="shivam-stack-hero-visual">
              <div className="shivam-stack-hero-visual-inner">
                <div className="shivam-stack-code-window">
                  ...
                  <div className="shivam-stack-code-body">
                    {codeSnippet.map((line, i) => (
                      <div key={i}>
                        {line.type === "comment" && (
                          <span className="shivam-stack-code-comment">
                            {line.text}
                          </span>
                        )}
                        {line.type === "keyword" && (
                          <span>
                            <span className="shivam-stack-code-keyword">
                              {line.text}
                            </span>
                        ...
                        {line.type === "string" && (
                          <span className="shivam-stack-code-string">
                            {line.text}
                          </span>
                        )}
                        {line.type === "function" && (
                          <span>
                            <span className="shivam-stack-code-function">
                              {line.text}
                            </span>
                ...
                <div className="shivam-stack-hero-floating-badge shivam-stack-hero-floating-badge--2">
                  ...
                  <div>
                    <div className="shivam-stack-floating-badge-text">
                      Delivered in Sprints
                    </div>
                    <div className="shivam-stack-floating-badge-sub">
                      Weekly demos
                    </div>
                  </div>
                </div>
      ...
      {/* ── WHAT I BUILD ── */}
      <section
        className="shivam-stack-section"
        style={{ background: "var(--ss-bg-secondary)" }}
      >
        <div className="shivam-stack-container">
          <div className="shivam-stack-section-header">
            ...
            <p className="shivam-stack-section-desc">
              Full stack doesn't mean frontend + backend bolted together. It
              means a cohesive system where every layer is designed to work in
              harmony.
            </p>
          </div>
          ...
          <div className="shivam-stack-fsd-layers">
            {[
              ...
              <div
                key={i}
                className="shivam-stack-fsd-layer-card"
              ...
              >
                ...
                <div className="shivam-stack-fsd-layer-items">
                  {l.items.map((item, j) => (
                    <span key={j} className="shivam-stack-fsd-layer-item">
                      {item}
                    </span>
                  ))}
                </div>
      ...
      <section className="shivam-stack-section">
        <div className="shivam-stack-container">
          <div className="shivam-stack-section-header">
            ...
            <p className="shivam-stack-section-desc">
              Every tool chosen for a reason — performance, developer
          ...
          <div className="shivam-stack-tabs-nav">
            {Object.entries(techTabs).map(([key, tab]) => (
              <button
                key={key}
                className={`shivam-stack-tab-btn ${activeTab === key ? "shivam-stack-tab-btn--active" : ""}`}
      ...
      >
        <div className="shivam-stack-container">
          <div className="shivam-stack-section-header">
            ...
            <p className="shivam-stack-section-desc">
              These aren't add-ons. They're built into every full stack project
              I deliver.
            </p>
          </div>
      ...
      <section className="shivam-stack-section">
        <div className="shivam-stack-container">
          <div className="shivam-stack-section-header">
            ...
            <p className="shivam-stack-section-desc">
              Real apps for real clients. Each one battle-tested in production.
            </p>
          </div>
            ...
            {projects.map((p, i) => (
              <div key={i} className="shivam-stack-fsd-project-card">
                ...
                <div className="shivam-stack-fsd-project-info">
                  ...
                  <div className="shivam-stack-fsd-project-title">
                    {p.title}
                  </div>
                  <div className="shivam-stack-fsd-project-stack">
                    {p.stack}
                  </div>
                  <div className="shivam-stack-fsd-project-duration">
                    ⏱ {p.duration}
                  </div>
                </div>
              </div>
      ...
      >
        <div className="shivam-stack-container">
          <div className="shivam-stack-section-header">
            ...
            <p className="shivam-stack-section-desc">
              My structured 6-step process ensures nothing falls through the
              cracks.
            </p>
          </div>

          <div
            className="shivam-stack-grid-2"
              ...
              {processSteps.slice(0, 3).map((step, i) => (
                <div key={i} className="shivam-stack-process-item">
                  ...
                  <div className="shivam-stack-process-content">
                    <div className="shivam-stack-process-title">
        ...
        <div className="shivam-stack-container">
          <div className="shivam-stack-fsd-deliverables-wrap">
            <div>
              ...
              <p
                className="shivam-stack-section-desc"
                style={{ marginBottom: "2rem" }}
              >
                When the project ships, you get more than just code. You get
                everything you need to maintain, scale, and hand off to any
                developer.
              </p>
              <div className="shivam-stack-fsd-deliverables-list">
                {deliverables.map((item, i) => (
                  <div key={i} className="shivam-stack-fsd-deliverable-item">
                    <span className="shivam-stack-fsd-deliverable-check">
                      ✓
                    </span>
                    <span>{item}</span>
                  </div>
            ...
            <div
              className="shivam-stack-img-wrapper shivam-stack-img-wrapper--auto"
              style={{ minHeight: 400 }}
            >
      ...
      >
        <div className="shivam-stack-container">
          <div className="shivam-stack-section-header">
            ...
            <p className="shivam-stack-section-desc">
              No hidden charges. No surprises. Scope agreed upfront, price
              fixed.
            </p>
          </div>
          ...
          <div className="shivam-stack-grid-3">
            {[
              ...
              <div
                key={i}
                className={`shivam-stack-pricing-card ${tier.featured ? "shivam-stack-pricing-card--featured" : ""}`}
              >
                {tier.featured && (
                  <div className="shivam-stack-pricing-badge">Most Popular</div>
                )}
                <div className="shivam-stack-pricing-plan">{tier.plan}</div>
                <div className="shivam-stack-pricing-price">{tier.price}</div>
                <div className="shivam-stack-pricing-price-note">
                  {tier.note}
                </div>
                ...
                <a
                  href="/contact"
                  className={`shivam-stack-btn ${tier.featured ? "shivam-stack-btn--primary" : "shivam-stack-btn--secondary"}`}
            ...
            {faqs.map((faq, i) => (
              ...
              >
                <div className="shivam-stack-faq-question">
                  <span>{faq.q}</span>
                  <span className="shivam-stack-faq-icon">
                    {openFaq === i ? "−" : "+"}
                  </span>
                </div>
                {openFaq === i && (
      ...
      <div className="shivam-stack-container">
        <div className="shivam-stack-cta-section">
          ...
          <p className="shivam-stack-cta-desc">
            ...
            requirements and I'll give you a detailed proposal within 24 hours.
          </p>
