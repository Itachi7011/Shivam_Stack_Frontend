...
const AllServices = () => {
  ...
  const services = [
    {
      ...
      link: "/services/full-stack-development", // ✅ updated
      iconClass: "",
    },
    {
      emoji: "🛡️",
      ...
      link: "/services/admin-panel-cms-development", // ✅ updated
    ...
    },
    {
      ...
      link: "/services/performance-optimization", // ✅ updated
    ...
    },
    {
      ...
      link: "/services/devops-deployment", // ✅ updated
    ...
    },
    {
      ...
      link: "/services/ecommerce-solutions", // ✅ updated
      iconClass: "",
    },
    {
      emoji: "🔌",
      ...
      link: "/services/api-development", // ✅ updated
      iconClass: "shivam-stack-card-icon--purple",
    },
    {
      emoji: "💼",
      ...
      link: "/services/portfolio-website-development", // ✅ updated
      iconClass: "shivam-stack-card-icon--gold",
    },
    {
      emoji: "🔧",
      ...
      link: "/services/maintenance-support", // ✅ updated
      iconClass: "shivam-stack-card-icon--green",
    },
  ];
  ...
  const whyPoints = [
    {
      ...
      desc: "Every UI element is crafted with meticulous attention to detail — spacing, typography, animation timing.",
    },
    {
      icon: "⚡",
      title: "Blazing Fast Delivery",
      desc: "I follow Agile sprints. You get working deliverables every week, not at the end of the project.",
    },
    {
      icon: "🔒",
      title: "Security First",
      desc: "OWASP top 10 hardening, helmet.js, rate limiting, input validation, and JWT best practices built-in.",
    },
    {
      icon: "📱",
      title: "Mobile-First Always",
      desc: "All apps are fully responsive. Tested on 15+ screen sizes from 320px to 4K monitors.",
    },
    {
      icon: "📖",
      title: "Clean, Documented Code",
      desc: "JSDoc comments, README files, inline documentation, and Swagger API docs for every project.",
    },
    {
      icon: "🤝",
      title: "Long-term Partnership",
      desc: "I do not disappear after launch. Ongoing support, updates, and feature additions whenever you need.",
    },
  ];
  ...
  const processSteps = [
    {
      ...
      desc: "We discuss your requirements, timeline, and tech stack. I create a detailed scope document.",
    },
    {
      num: "02",
      title: "Architecture & Planning",
      desc: "Database schema, system design diagrams, component hierarchy, and API structure finalized.",
    },
    {
      num: "03",
      title: "Development Sprints",
      desc: "Weekly sprints with demos. Frontend, backend, and database developed in parallel where possible.",
    },
    {
      num: "04",
      title: "Testing & QA",
      desc: "Unit tests, integration tests, E2E tests with Playwright, performance audits, and security scans.",
    },
    {
      num: "05",
      title: "Deployment & Go-Live",
      desc: "Configured CI/CD, Docker deployment, domain setup, SSL, and monitored launch.",
    },
    {
      num: "06",
      title: "Maintenance & Growth",
      desc: "Post-launch support, feature additions, performance monitoring, and analytics setup.",
    },
  ];

  const faqs = [
    {
      q: "How long does a full-stack project typically take?",
      a: "It depends on complexity. A simple MERN app takes 2–4 weeks. A full e-commerce platform with admin panel can take 6–12 weeks. I will give you an accurate timeline after our discovery call.",
    },
    {
      q: "Do you work on existing codebases or only new projects?",
      a: "Both! I regularly take on legacy code refactoring, bug fixing, performance optimization of existing projects, and adding new features to live applications.",
    },
    {
      q: "What payment methods do you accept?",
      a: "UPI, bank transfer, PayPal, and Razorpay. I usually work on 50% upfront and 50% on completion, with milestones for larger projects.",
    },
    {
      q: "Can you sign an NDA for my project?",
      a: "Absolutely. I sign NDAs before any sensitive discussion. Your business idea, source code, and data remain fully confidential.",
    },
    {
      q: "Do you provide post-launch support?",
      a: "Yes. All projects include 30 days of free bug-fix support. I also offer monthly maintenance retainers at flexible rates.",
    },
    {
      q: "What if I need changes mid-project?",
      a: "Minor scope adjustments are handled gracefully. For larger changes, we revise the scope document and timeline together — no hidden charges.",
    },
  ];
  ...
  const detailedServices = [
    ...
    },
    {
      ...
      title: "E-Commerce Solutions",
      detail:
        "Full e-commerce platforms with product catalog, variants, inventory tracking, shopping cart with local/session persistence, wishlist, order management, coupon and discount system, Stripe and Razorpay payment integration, order email notifications, admin dashboard with sales analytics, customer management, and shipping status updates.",
    },
    {
      icon: "🔌",
      title: "API Development",
          ...
          <div className="shivam-stack-hero-content shivam-stack-hero-content--centered">
            <div className="shivam-stack-hero-left">
              ...
              <p className="shivam-stack-hero-subtitle">
                I'm Shivam — a MERN stack developer offering end-to-end web
                development services. From ideation to deployment, I build fast,
        ...
        <div className="shivam-stack-container">
          <div className="shivam-stack-section-header">
            ...
            <p className="shivam-stack-section-desc">
              No agency overhead. No miscommunication. One skilled full-stack
              developer who understands your vision and executes it with
              precision.
            </p>
          </div>
            ...
            {services.map((svc, i) => (
              ...
              >
                <div className="shivam-stack-service-link-card-top">
                  ...
                  <div>
                    <div
                      className="shivam-stack-card-title"
                      style={{ marginBottom: "0.25rem" }}
                    >
                      {svc.title}
                    </div>
                    <div
                      className="shivam-stack-tech-grid"
                      style={{ marginTop: 0 }}
                    >
                      {svc.tags.map((tag, j) => (
                        <span key={j} className="shivam-stack-tech-badge">
                          {tag}
                        </span>
                      ))}
                    </div>
                ...
                <div className="shivam-stack-service-link-card-body">
                  {svc.desc}
                </div>
                <div className="shivam-stack-service-link-card-footer">
                  View Details →
                </div>
              </a>
            ))}
      ...
      >
        <div className="shivam-stack-container">
          <div className="shivam-stack-section-header">
            ...
            <p className="shivam-stack-section-desc">
              Battle-tested tools and frameworks I use daily to build
          ...
          <div className="shivam-stack-all-services-stack-row">
            {techStack.map((t, i) => (
              <div key={i} className="shivam-stack-all-services-stack-item">
                <span className="shivam-stack-all-services-stack-icon">
                  {t.icon}
                </span>
                <div className="shivam-stack-all-services-stack-name">
                  {t.name}
                </div>
              </div>
            ))}
        ...
        <div className="shivam-stack-container">
          <div className="shivam-stack-all-services-why-grid">
            ...
            <div>
              ...
              >
                I've worked with startups, agencies, and solo founders. Here's
          ...
          >
            <div className="shivam-stack-process-list">
              {processSteps.slice(0, 3).map((step, i) => (
                <div
                  key={i}
                  className="shivam-stack-process-item"
      ...
      >
        <div className="shivam-stack-container">
          ...
          <div className="shivam-stack-grid-3">
            {[
              {
                text: "Shivam delivered a complete e-commerce platform in 6 weeks. The code quality is exceptional and everything works flawlessly. Will hire again without a doubt.",
                name: "Rajesh Kumar",
                role: "Startup Founder",
              },
              {
                text: "Best freelance MERN developer I've worked with. He's proactive, communicates clearly, and his code is clean enough that my team can maintain it easily.",
                name: "Sarah Mitchell",
                role: "Product Manager",
              },
              {
                text: "The admin dashboard Shivam built transformed how we manage our business. Real-time data, beautiful design, and extremely fast performance.",
                name: "Amit Sharma",
              ...
              <div key={i} className="shivam-stack-testimonial-card">
                ...
                <div className="shivam-stack-testimonial-author">
                  <div className="shivam-stack-testimonial-avatar">
                    <div
                      className="shivam-stack-img-placeholder"
                      style={{
                        position: "static",
                        width: 46,
                        height: 46,
                  ...
                  <div>
                    <div className="shivam-stack-testimonial-name">
                      {t.name}
                    </div>
                    <div className="shivam-stack-testimonial-role">
                      {t.role}
                    </div>
                  </div>
                </div>
      ...
      <div className="shivam-stack-container">
        <div className="shivam-stack-cta-section">
          ...
          <p className="shivam-stack-cta-desc">
            Let's turn your idea into a fully functional, beautifully designed
            web application. Book a free 30-minute discovery call today.
          </p>
