...
// Environment variables for social links and contact
const SOCIAL_LINKS = {
...
const CONTACT_INFO = {
  email: import.meta.env.VITE_Email || "shivam@shivamstack.dev",
  phone: import.meta.env.VITE_Mobile || "",
...
const INDUSTRIES = [
  {
    ...
    name: "FinTech",
    desc: "Dashboards, payment systems, analytics platforms",
  },
  {
    icon: <Heart size={24} />,
    name: "HealthTech",
    desc: "Patient portals, booking systems, telemedicine apps",
  },
  {
    icon: <BookOpen size={24} />,
    name: "EdTech",
    desc: "LMS platforms, course marketplaces, quiz systems",
  },
  {
    icon: <Package size={24} />,
    name: "E-Commerce",
    desc: "Product stores, inventory management, checkout flows",
  },
  {
    icon: <Briefcase size={24} />,
    name: "SaaS Startups",
    desc: "MVP to production, billing, user management",
  },
  {
    icon: <Globe size={24} />,
    name: "Media & Blogs",
    desc: "Content platforms, CMS, SEO-optimized sites",
  },
  {
    icon: <Target size={24} />,
    name: "Marketing",
    desc: "Landing pages, lead funnels, campaign dashboards",
  },
  {
    icon: <Box size={24} />,
    name: "Real Estate",
    desc: "Property listings, booking, agent portals",
  },
];
...
const PROCESS_STEPS = [
  {
    ...
    desc: "We start with a 30-min call to understand your goals, requirements, tech stack, and timeline.",
    icon: <MessageSquare size={22} />,
  },
  {
    step: "02",
    title: "Scope & Proposal",
    desc: "I send a detailed project scope, timeline, and fixed-price proposal within 24 hours.",
    icon: <FileCode size={22} />,
  },
  {
    step: "03",
    title: "Design & Architecture",
    desc: "UI wireframes, database schema, and technical architecture are planned before a single line of code.",
    icon: <Layers size={22} />,
  },
  {
    step: "04",
    title: "Iterative Development",
    desc: "Development happens in sprints with regular demos — you see progress every week, not just at the end.",
    icon: <GitBranch size={22} />,
  },
  {
    step: "05",
    title: "Testing & QA",
    desc: "Thorough testing across devices, browsers, and edge cases. Performance and security audits included.",
    icon: <Shield size={22} />,
  },
  {
    step: "06",
    title: "Launch & Support",
    desc: "Clean handoff with documentation, deployment, and 30 days of free post-launch support.",
    icon: <Rocket size={22} />,
  },
];
...
const WHY_ME = [
  {
    icon: <Zap size={22} />,
    title: "Fast Delivery",
    desc: "Most projects delivered 20% ahead of schedule. Speed without cutting corners.",
  },
  {
    icon: <Shield size={22} />,
    title: "Clean Code",
    desc: "Well-documented, scalable, and maintainable code following industry standards.",
  },
  {
    icon: <MessageSquare size={22} />,
    title: "Clear Communication",
    desc: "Daily updates, transparent timelines, and zero surprises throughout the project.",
  },
  {
    icon: <RefreshCw size={22} />,
    title: "Unlimited Revisions",
    desc: "Your satisfaction matters. Revisions are part of the process, not an extra cost.",
  },
  {
    icon: <Lock size={22} />,
    title: "Security First",
    desc: "Every application is built with security best practices baked in from day one.",
  },
  {
    icon: <TrendingUp size={22} />,
    title: "Growth Focused",
    desc: "I build for scale. Your project is architected to handle 10x growth without rebuilds.",
  },
];
...
const FAQS = [
  {
    ...
    a: "Most small projects take 1–2 weeks, medium projects 3–6 weeks, and large SaaS platforms 6–12 weeks. I'll give you a precise timeline in the proposal after understanding your requirements.",
  },
  {
    q: "Do you offer fixed-price or hourly billing?",
    a: "Both! Fixed-price for well-defined projects (most common), and hourly for ongoing work, consulting, or projects with evolving requirements.",
  },
  {
    q: "Can you work with an existing codebase?",
    a: "Absolutely. I regularly take over and improve existing projects. I'll do a quick audit first to understand the codebase, then propose a clean improvement plan.",
  },
  {
    q: "What tech stack do you primarily work with?",
    a: "My primary stack is MERN (MongoDB, Express, React, Node.js) with TypeScript. I also work with Next.js, PostgreSQL, Redis, Docker, and AWS.",
  },
  {
    q: "Do you provide source code and documentation?",
    a: "Yes, always. You get full source code, a structured README, API documentation, and a deployment guide. The project is 100% yours.",
  },
  {
    q: "Do you offer post-launch support?",
    a: "Every project includes 30 days of free post-launch support. After that, I offer affordable monthly maintenance retainers.",
  },
];
...
const ACHIEVEMENTS = [
  {
    ...
    desc: "Consistently rated 5★ across platforms",
  },
  {
    icon: <TrendingUp size={22} />,
...
const [showNameInput, setShowNameInput] = useState(false);
  ...
  const filteredTech =
    techFilter === "All"
      ? TECH_STACK
      : TECH_STACK.filter((t) => t.category === techFilter);
      ...
      <section className="shivam-stack-homepage-section shivam-stack-homepage-store-section">
        <div className="shivam-stack-homepage-container">
          <div className="shivam-stack-homepage-section-header">
            ...
            <h2 className="shivam-stack-homepage-section-title">
              Premium Products & Resources
            </h2>
            <p className="shivam-stack-homepage-section-desc">
              Production-ready starter kits, UI kits, and source code to
            ...
            {PRODUCTS.map((p, i) => (
              <div key={i} className="shivam-stack-homepage-product-card">
                <div className="shivam-stack-homepage-product-header">
                  <div className="shivam-stack-homepage-product-icon">
                    {p.icon}
                  </div>
                  <span className="shivam-stack-homepage-product-type">
                    {p.type}
                  </span>
                </div>
                <h3 className="shivam-stack-homepage-product-title">
                  {p.title}
                </h3>
                ...
                <div className="shivam-stack-homepage-product-footer">
                  <div className="shivam-stack-homepage-product-pricing">
                    <span className="shivam-stack-homepage-product-price">
                      {p.price}
                    </span>
                    <span className="shivam-stack-homepage-product-original">
                      {p.originalPrice}
                    </span>
                  </div>
                  <div className="shivam-stack-homepage-product-meta">
                    <span className="shivam-stack-homepage-product-rating">
                      <Star size={11} fill="currentColor" /> {p.rating}
                    </span>
                    <span className="shivam-stack-homepage-product-sales">
                      {p.sales} sold
                    </span>
                  </div>
                </div>
                <Link
                  to="/store"
                  className="shivam-stack-homepage-btn-primary shivam-stack-homepage-product-btn"
                >
          ...
          <div className="shivam-stack-homepage-section-cta">
            <Link to="/store" className="shivam-stack-homepage-btn-ghost">
              Browse Full Store <ArrowRight size={15} />
            </Link>
          </div>
        </div>
      </section>
      ...
      <section className="shivam-stack-homepage-section shivam-stack-homepage-resources-section">
        <div className="shivam-stack-homepage-container">
          <div className="shivam-stack-homepage-section-header">
            ...
            <p className="shivam-stack-homepage-section-desc">
              High-quality guides, cheatsheets, and templates — completely free.
              No email required.
            </p>
          </div>
            ...
            {FREE_RESOURCES.map((r, i) => (
              <div key={i} className="shivam-stack-homepage-resource-card">
                <div className="shivam-stack-homepage-resource-top">
                  <div className="shivam-stack-homepage-resource-icon">
                    {r.icon}
                  </div>
                  <span className="shivam-stack-homepage-resource-type">
                    {r.type}
                  </span>
                </div>
                <h3 className="shivam-stack-homepage-resource-title">
                  {r.title}
                </h3>
                <p className="shivam-stack-homepage-resource-desc">{r.desc}</p>
                <div className="shivam-stack-homepage-resource-footer">
                  <span className="shivam-stack-homepage-resource-downloads">
                    <Download size={12} /> {r.downloads} downloads
                  </span>
                  <Link
                    to="/resources"
                    className="shivam-stack-homepage-resource-link"
                  >
      ...
      <section className="shivam-stack-homepage-section shivam-stack-homepage-opensource-section">
        <div className="shivam-stack-homepage-container">
          <div className="shivam-stack-homepage-section-header">
            ...
            <p className="shivam-stack-homepage-section-desc">
              I believe in giving back. Here are some of my most-starred open
              source projects.
            </p>
          </div>
            ...
            {OPEN_SOURCE.map((repo, i) => (
              <div key={i} className="shivam-stack-homepage-repo-card">
                <div className="shivam-stack-homepage-repo-header">
                  <Github
                    size={18}
                    className="shivam-stack-homepage-repo-icon"
                  />
                  <a
                    href={`${SOCIAL_LINKS.github}/${repo.name}`}
                    target="_blank"
                    rel="noreferrer"
                    className="shivam-stack-homepage-repo-name"
                  >
                    {repo.name}
                  </a>
                  <ExternalLink
                    size={13}
                    className="shivam-stack-homepage-repo-ext"
                  />
                </div>
                ...
                <div className="shivam-stack-homepage-repo-footer">
                  <span className="shivam-stack-homepage-repo-lang">
                    <span
                      className="shivam-stack-homepage-repo-lang-dot"
                      style={{ background: repo.langColor }}
                    />
                    {repo.lang}
                  </span>
                  <span className="shivam-stack-homepage-repo-stat">
