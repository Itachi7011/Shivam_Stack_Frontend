...
export default function Resources() {
  ...
  const usefulLinks = [
    {
      ...
      links: [
        ...
        },
        {
          ...
          desc: "Official Node.js documentation.",
        },
        {
          name: "MongoDB Manual",
          url: "https://www.mongodb.com/docs/manual",
          desc: "Complete MongoDB reference.",
        },
        {
          name: "Express.js Guide",
          url: "https://expressjs.com/en/guide",
          desc: "Express routing, middleware, and API reference.",
        },
      ],
    },
    {
      ...
      links: [
        {
          ...
          desc: "Premium UI components by the Tailwind CSS team.",
        },
        {
          name: "Heroicons",
          url: "https://heroicons.com",
          desc: "Beautiful SVG icons by the Tailwind team.",
        },
        {
          name: "Lucide Icons",
          url: "https://lucide.dev",
          desc: "Open-source icon library with 1000+ icons.",
        },
        {
          name: "Google Fonts",
          url: "https://fonts.google.com",
          desc: "Free, open-source fonts.",
        },
      ],
    },
    {
      ...
      links: [
        {
          ...
          desc: "API testing and documentation tool.",
        },
        {
          name: "MongoDB Atlas",
          url: "https://www.mongodb.com/cloud/atlas",
          desc: "Free cloud MongoDB hosting.",
        },
        {
          name: "Cloudinary",
          url: "https://cloudinary.com",
          desc: "Free image/video CDN and transformation.",
        },
        {
          name: "Vercel",
          url: "https://vercel.com",
          desc: "Best platform for deploying React apps.",
        },
      ],
    },
    {
      ...
      links: [
        {
          ...
          desc: "The most comprehensive JS tutorial online.",
        },
        {
          name: "The Odin Project",
          url: "https://www.theodinproject.com",
          desc: "Free full-stack curriculum.",
        },
        {
          name: "CS50 (Harvard)",
          url: "https://cs50.harvard.edu",
          desc: "Free computer science foundations course.",
        },
        {
          name: "FreeCodeCamp",
  ...
  const myProjectsShowcase = [
    {
      name: "AuthNester",
      desc: "Full auth system",
    ...
    {
      name: "Law Firm Site",
      desc: "Professional firm website",
  ...
  const skillsData = [
    ...
    {
      skill: "AWS S3 + Cloudinary",
      level: 84,
      years: "2 years",
      category: "Cloud",
    },
    {
      skill: "Stripe / Payment APIs",
      level: 86,
      years: "2 years",
      category: "Payments",
    },
  ...
  const servicesData = [
    {
      ...
      desc: "End-to-end MERN web application development — from database design to React UI to Node.js API to deployment.",
    },
    {
      icon: "🎨",
      title: "Frontend (React/Next.js)",
      desc: "Pixel-perfect, responsive React or Next.js applications with excellent UX, performance, and accessibility.",
    },
    {
      icon: "⚙️",
      title: "REST API Development",
      desc: "Robust and scalable RESTful APIs with Express.js, proper error handling, validation, and API documentation.",
    },
    {
      icon: "🛒",
      title: "E-Commerce Solutions",
      desc: "Full e-commerce platforms with product management, payments, cart, order management, and admin dashboard.",
    },
    {
      icon: "🤖",
      title: "AI-Integrated Apps",
      desc: "MERN applications with OpenAI/Gemini API integration for AI-powered features, chatbots, or content generation.",
    },
    {
      icon: "🔌",
      title: "API Integrations",
      desc: "Third-party API integrations — Stripe, Twilio, Cloudinary, SendGrid, Google APIs, Razorpay, and more.",
    },
    {
      icon: "🔄",
      title: "Code Review & Refactor",
      desc: "Professional code review, architecture audit, and codebase refactoring for existing MERN projects.",
    },
    {
      icon: "📱",
      title: "Responsive UI Conversion",
      desc: "Convert existing web apps to fully mobile-responsive with modern design, dark mode, and smooth animations.",
    },
  ];

  const faqs = [
    {
      q: "Are all the free resources actually free?",
      a: "Yes! All resources marked as free are completely free to download — no email signup required for most. A few resources require a free account for tracking updates.",
    },
    {
      q: "Can I share these resources with my team or community?",
      a: "Free resources can be shared freely. Paid resources are licensed per-person. Please do not redistribute paid resources — it hurts independent creators.",
    },
    {
      q: "How often are resources updated?",
      a: 'Resources are updated when significant changes occur in the related technology. You can see the "Updated" date on each resource card.',
    },
    {
      q: "Can I request a specific cheat sheet or resource?",
      a: "Absolutely! Email me or use the contact form to request a specific resource. Popular requests get prioritized.",
    },
    {
      q: "Are the roadmaps PDF or interactive?",
      a: "Roadmaps are available as high-resolution PDF files that you can print, annotate, or keep on your desktop. Some will be interactive web versions soon.",
    },
  ];

  // Handle download - using the same method as old design
  const handleDownload = async (productId, productName) => {
    try {
      setDownloading(productId);

      // Call the download endpoint to get the download URL
      const response = await fetch(`/api/public/download/${productId}`);
      ...
      if (result.success && result.data.downloadUrl) {
        ...
        link.download = result.data.fileName || `${productName}.pdf`;
        document.body.appendChild(link);
        link.click();
        document.body.removeChild(link);

        // Show success message (optional)
        console.log(`Download started: ${result.data.fileName}`);
      } else {
    ...
    const fetchProducts = async () => {
      try {
        ...
        if (result.success) {
          ...
          setResourcesData(products);

          // Generate categories from product types or tags
          const typeSet = new Set(["All"]);
          products.forEach((product) => {
            // Use type field if available, otherwise use category name
            const type = product.type || product.category?.name;
            ...
            if (product.tags && Array.isArray(product.tags)) {
              product.tags.forEach((tag) => {
                ...
                if (
                  ["Cheat", "Roadmap", "Tool", "Premium"].some((t) =>
                    formattedTag.includes(t),
                  )
                ) {
                  typeSet.add(formattedTag);
                }
              });
            }
          });
  ...
  const getDisplayType = (product) => {
    ...
    return product.category?.name || "Resources";
  };

  // Filter resources based on type and search
  const filtered = resourcesData.filter((product) => {
    const displayType = getDisplayType(product);
    const matchType = activeType === "All" || displayType === activeType;
    const matchSearch =
  ...
  const freeResources = resourcesData.filter((p) => p.isFree === true).length;
  ...
  const freePercentage =
    resourcesData.length > 0
      ? Math.round((freeResources / resourcesData.length) * 100)
      : 100;
  ...
  if (error) {
    return (
      <div className={`ss-page-wrapper ${isDarkMode ? "dark" : "light"}`}>
        ...
        >
          <div style={{ textAlign: "center", color: "var(--ss-text-muted)" }}>
      ...
      <section className="ss-page-hero">
        ...
        <div className="ss-page-hero-content ss-animate-in">
          ...
          <p className="ss-page-hero-subtitle">
            Free cheat sheets, roadmaps, tools, scripts, and curated links —
            everything a MERN developer needs to learn faster, build smarter,
            and ship better.
          </p>
          <div className="ss-page-hero-stats">
            ...
            <div className="ss-page-hero-stat">
              <div className="ss-page-hero-stat-number">
                {Math.floor(totalDownloads / 1000)}k<span>+</span>
              </div>
              <div className="ss-page-hero-stat-label">Downloads</div>
            </div>
            <div className="ss-page-hero-stat">
              <div className="ss-page-hero-stat-number">
                {myProjectsShowcase.length}
                <span>+</span>
              </div>
        ...
        <div className="ss-container">
          <div className="ss-section-header">
            ...
            {/* <p className="ss-section-desc">
              Cheat sheets, roadmaps, scripts, and tools — download and use
          ...
          <div className="ss-filter-bar">
            {categories.map((type) => (
              <button
                key={type}
                className={`ss-filter-btn ${activeType === type ? "ss-filter-active" : ""}`}
          ...
          <div className="ss-resource-grid">
            {filtered.map((product, i) => (
              <div
                className={`ss-resource-card ss-animate-in ss-animate-delay-${(i % 5) + 1}`}
                key={product._id}
              >
                <div
                  style={{
                ...
                >
                  <div className="ss-resource-type-icon">
                    {product.emoji || (product.isFree ? "📋" : "💎")}
                  </div>
                  <div style={{ flex: 1 }}>
                    <div
                      style={{
                    ...
                    >
                      <div className="ss-resource-card-title">
                        {product.name}
                      </div>
                      {product.isFree ? (
                        <span
                          className="ss-product-card-badge ss-badge-free"
                        ...
                        <span
                          className="ss-product-card-badge ss-badge-pro"
                          style={{ position: "static" }}
                        >
                          ₹{product.price || 0}
                        </span>
                ...
                <p className="ss-resource-card-desc">
                ...
                <div className="ss-resource-card-meta">
                  ...
                  <button
                    ...
                    onClick={() => {
                      if (product.isFree) {
                        handleDownload(product._id, product.name);
                      } else {
                        // Handle buy action
                        alert(
                          "This is a premium resource. Purchase functionality coming soon!",
                        );
                      }
                    }}
      ...
      <section className="ss-section ss-section-alt">
        <div className="ss-container">
          <div className="ss-section-header">
            ...
            <p className="ss-section-desc">
              Every project is live, functional, and open for exploration. See
              the work in action.
            </p>
          </div>
          <div
          ...
          >
            {myProjectsShowcase.map((project, i) => (
              <a
                key={i}
                href={project.url}
                target="_blank"
              ...
              >
                ...
                >
                  ...
                  <div>
                    <div
                      className="ss-resource-card-title"
      ...
      <section className="ss-section">
        <div className="ss-container">
          <div className="ss-section-header">
            ...
            <p className="ss-section-desc">
              My personal list of the best tools, documentation, and learning
              resources — tested and used daily.
            </p>
          </div>
          <div
            style={{
      ...
      <section className="ss-section ss-section-alt">
        <div className="ss-container">
          <div className="ss-section-header">
            ...
            <p className="ss-section-desc">
              A transparent overview of skills, proficiency levels, and years of
              experience.
            </p>
          </div>
          <div
      ...
      <section className="ss-section">
        <div className="ss-container">
          <div className="ss-section-header">
            ...
            <p className="ss-section-desc">
              Custom MERN development services tailored to your product needs
              and business goals.
            </p>
          </div>
      ...
      <section className="ss-cta-section">
        <div className="ss-cta-inner">
          ...
          <p className="ss-cta-desc">
            Subscribe to Shivam Stack's newsletter for early access to new cheat
            sheets, roadmaps, free tools, and discount codes on premium
