  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        label: "Categories",
        icon: <Tag size={15} />,
        link: "/admin/manage-product-categories",
        permission: "manage_products",
      },
      {
        id: "reviews",
    ...
    children: [
      {
        ...
        icon: <Mail size={15} />,
        link: "/admin/manage-contact-us-messages",
        permission: null,
      },
      {
        id: "newsletter",
        ...
        icon: <Bell size={15} />,
        link: "/admin/manage-news-letter-subscribers",
        permission: null,
      },
      {
        id: "newsletter",
        label: "Book Free Call Messages",
        icon: <Bell size={15} />,
        link: "/admin/manage-book-free-calls-messages",
        permission: null,
      },
    ],
  },
    ...
    >
        ...
        <div className="shivam-stack-admin-sidebar-brand">
          ...
          {isExpanded && (
            <div className="shivam-stack-admin-sidebar-brand-text">
              <span className="shivam-stack-admin-sidebar-brand-name">
                Shivam Stack
              </span>
              <span className="shivam-stack-admin-sidebar-brand-role">
                Admin Panel
              </span>
            </div>
          )}
              ...
              <li key={item.id} className="shivam-stack-admin-sidebar-nav-item">
                {hasChildren ? (
                  <>
                    ...
                    >
                      <span className="shivam-stack-admin-sidebar-nav-icon">
                        {item.icon}
                      </span>
                      {isExpanded && (
                        <>
                          <span className="shivam-stack-admin-sidebar-nav-label">
                            {item.label}
                          </span>
                          <span
                            className={`shivam-stack-admin-sidebar-nav-chevron ${isOpen ? "shivam-stack-admin-sidebar-nav-chevron-open" : ""}`}
                          >
                            <ChevronDown size={13} />
                          </span>
                        </>
                    ...
                    {isExpanded && (
                      <ul
                        className={`shivam-stack-admin-sidebar-dropdown ${isOpen ? "shivam-stack-admin-sidebar-dropdown-open" : ""}`}
                      >
                        {item.children.map((child) => (
                          <li
                            key={child.id}
                            className="shivam-stack-admin-sidebar-dropdown-item"
                          >
                            <Link
                              to={child.link}
                              className={`shivam-stack-admin-sidebar-dropdown-link ${isActive(child.link) ? "shivam-stack-admin-sidebar-dropdown-link-active" : ""}`}
                            >
                              <span className="shivam-stack-admin-sidebar-dropdown-icon">
                                {child.icon}
                              </span>
                              <span className="shivam-stack-admin-sidebar-dropdown-label">
                                {child.label}
                              </span>
                            </Link>
                          </li>
      ...
      <div className="shivam-stack-admin-sidebar-footer">
        ...
        >
          ...
          {isExpanded && (
            <span className="shivam-stack-admin-sidebar-nav-label">Logout</span>
          )}
        </button>
      </div>
    </aside>
