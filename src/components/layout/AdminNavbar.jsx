...
const pageTitles = {
  ...
  "/admin/analytics/revenue": {
    ...
    crumbs: ["Admin", "Analytics", "Revenue"],
  },
  ...
  "/admin/manage-blog": {
    title: "Manage Blog",
    crumbs: ["Admin", "Blog", "Manage"],
  },
  "/admin/manage-coupons": {
    title: "Manage Coupons",
    crumbs: ["Admin", "Coupons", "Manage"],
  },
  "/admin/manage-products": {
    title: "Manage Products",
    crumbs: ["Admin", "Products", "Manage"],
  },
  "/admin/manage-product-categories": {
    title: "Product Categories",
    crumbs: ["Admin", "Products", "Categories"],
  },
  "/admin/manage-projects": {
    title: "Manage Projects",
    crumbs: ["Admin", "Projects", "Manage"],
  },
};
...
const quickCreateItems = [
  {
    ...
    link: "/admin/manage-products/add",
  ...
  },
  {
    ...
    link: "/admin/manage-projects/add",
  ...
  },
  {
    ...
    label: "Create Coupon",
    icon: <Ticket size={14} />,
    link: "/admin/manage-coupons/create",
...
const AdminNavbar = () => {
  ...
  const filteredQuickCreate = quickCreateItems.filter(
    ...
    setNotifications([
      {
        ...
        desc: "React Mastery Course purchased",
        time: "2m ago",
        unread: true,
      },
      {
  ...
  return (
    <header
      className={`shivam-stack-admin-navbar-root ${isDarkMode ? "dark" : "light"} ${
        isExpanded
          ? "shivam-stack-admin-navbar-with-sidebar"
          : "shivam-stack-admin-navbar-with-sidebar-collapsed"
      }`}
    >
      {/* Left Section */}
      <div className="shivam-stack-admin-navbar-left">
        <div className="shivam-stack-admin-navbar-page-info">
          <h1 className="shivam-stack-admin-navbar-page-title">
            {pageInfo.title}
          </h1>
          <nav
            className="shivam-stack-admin-navbar-breadcrumb"
      ...
      <div
        className={`shivam-stack-admin-navbar-center ${searchFocused ? "shivam-stack-admin-navbar-center-focused" : ""}`}
        ref={searchRef}
      >
          ...
          <div className="shivam-stack-admin-navbar-search-dropdown">
            ...
            {searchQuery ? (
              <div className="shivam-stack-admin-navbar-search-result-hint">
                <Search size={13} />
                <span>
                  Search for "<strong>{searchQuery}</strong>" in{" "}
                  {activeSearchCat}
                </span>
              </div>
            ) : (
              <div className="shivam-stack-admin-navbar-search-empty">
                <span>
                  Start typing to search {activeSearchCat.toLowerCase()}…
                </span>
              </div>
            )}
          </div>
      ...
      <div className="shivam-stack-admin-navbar-right">
        ...
        {filteredQuickCreate.length > 0 && (
          <div
            className="shivam-stack-admin-navbar-dropdown-wrap"
            ref={quickCreateRef}
          >
            <button
            ...
            {quickCreateOpen && (
              <div className="shivam-stack-admin-navbar-dropdown shivam-stack-admin-navbar-qc-dropdown">
                ...
                {filteredQuickCreate.map((item) => (
                  ...
                  >
                    <span className="shivam-stack-admin-navbar-dropdown-item-icon">
                      {item.icon}
                    </span>
                    <span>{item.label}</span>
                    <ExternalLink
                      size={11}
                      className="shivam-stack-admin-navbar-dropdown-item-arrow"
                    />
                  </Link>
                ))}
              </div>
        ...
        <div className="shivam-stack-admin-navbar-dropdown-wrap" ref={notifRef}>
          ...
          >
            <Bell size={17} />
            {unreadCount > 0 && (
              <span className="shivam-stack-admin-navbar-notif-badge">
                {unreadCount}
              </span>
            )}
          </button>
          {notifOpen && (
            <div className="shivam-stack-admin-navbar-dropdown shivam-stack-admin-navbar-notif-dropdown">
              <div className="shivam-stack-admin-navbar-dropdown-header">
                ...
                {unreadCount > 0 && (
                  <span className="shivam-stack-admin-navbar-notif-count">
                    {unreadCount} new
                  </span>
                )}
              </div>
              <div className="shivam-stack-admin-navbar-notif-list">
                {notifications.map((notif) => (
                  ...
                  >
                    <span
                      className={`shivam-stack-admin-navbar-notif-item-icon shivam-stack-admin-navbar-notif-icon-${notif.type}`}
                    >
                      {notif.icon}
                    </span>
                    <div className="shivam-stack-admin-navbar-notif-item-body">
                      <span className="shivam-stack-admin-navbar-notif-item-title">
                        {notif.title}
                      </span>
                      <span className="shivam-stack-admin-navbar-notif-item-desc">
                        {notif.desc}
                      </span>
                    </div>
                    <span className="shivam-stack-admin-navbar-notif-item-time">
                      {notif.time}
                    </span>
                  </div>
                ))}
              ...
              <Link
                ...
                className="shivam-stack-admin-navbar-notif-view-all"
        ...
        >
          <div
            className={`shivam-stack-admin-navbar-theme-icon-wrap ${isDarkMode ? "shivam-stack-admin-navbar-theme-dark" : "shivam-stack-admin-navbar-theme-light"}`}
          >
        ...
        >
          ...
          >
            ...
            <ChevronDown
              size={13}
              className={`shivam-stack-admin-navbar-profile-chevron ${profileOpen ? "shivam-stack-admin-navbar-profile-chevron-open" : ""}`}
            />
          </button>
          {profileOpen && (
